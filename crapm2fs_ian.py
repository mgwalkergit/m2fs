...
#                infile=fitsfile[i].split('.fits')[0]+'_postfit_ian.fits'
                ...
                for j in range(0,len(postfit[6].data)):
                    ...
                    postfit_wav_npoints.append(postfit[6].data['wav_npoints'][j].tolist())
        ...
        piss=np.where(postfit_allmasked==0)[0]
        ppp1=[]
        ppp2=[]
        ppp3=[]
        ppp4=[]
        ppp5=[]
        ppp6=[]
        for zzz in range(0,len(piss)):
            ppp1.append(postfit_wav_npoints[piss[zzz]])
            ppp2.append(postfit_wav_rms[piss[zzz]])
            ppp3.append(postfit_wav_resolution[piss[zzz]])
            ppp4.append(postfit_wav_min[piss[zzz]])
            ppp5.append(postfit_wav_max[piss[zzz]])
            ppp6.append(postfit_temperature[piss[zzz]])
...
#        postfit_temperature=np.array(postfit_temperature)[np.where(postfit_allmasked==0)[0]]
        postfit_wav_npoints=ppp1
        postfit_wav_rms=ppp2
        postfit_wav_resolution=ppp3
        postfit_wav_min=ppp4
        postfit_wav_max=ppp5
        postfit_temperature=ppp6
